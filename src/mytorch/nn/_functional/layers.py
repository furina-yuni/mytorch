...
def conv1d(input, weight, bias=None, stride=1, padding=0, dilation=1, groups=1):
    from .._modules.convolution import convolution
...
def conv_transpose1d(
    ...
    from .._modules.convolution import convolution_transpose
...
def max_pool1d(input, kernel_size, stride=None, padding=0):
    from .._modules.pooling import pool_nd
...
def adaptive_max_pool1d(input, output_size):
    from .._modules.pooling import adaptive_pool_nd
...
def scaled_dot_product_attention(
    ...
    from .._modules.attention import scaled_dot_product_attention as implementation
